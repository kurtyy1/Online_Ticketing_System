						...
						<?php
						 ...
						 <tr>
						 	...
						 	<td>
						 		...
						 		<p><small>Location :<b><?php echo isset($aname[$row['departure_airport_id']]) ? $aname[$row['departure_airport_id']].' - ' : '' ?><?php echo isset($aname[$row['arrival_airport_id']]) ? $aname[$row['arrival_airport_id']] : '' ?></small></b></p>
								...
								<p><small>Return :<b><?php echo date('M d,Y h:i A',strtotime($row['return_datetime'])) ?></small></b></p>
							<?php endif; ?>
						</div>
						 		</div>
						 		</div>
						 	</td>
						 	<td class="text-right"><?php echo $row['seats_economy'] ?></td>
						 	<td class="text-right"><?php echo $booked ?></td>
						 	<td class="text-right"><?php echo number_format($row['price'],2) ?></td>
							<td class="text-right"><?php echo $row['kilometers']?></td>
